...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
     ...
     <a href="about.php" ><img src="assets/img/testimonials/testimonials-2.jpg" class="img-rounded"  alt="Cinque Terre" width="30" height="30"> </a>
     <a href="about.php"><?php echo $uname;?></a>
     </div>
